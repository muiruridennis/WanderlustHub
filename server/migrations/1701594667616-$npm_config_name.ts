...
export class $npmConfigName1701594667616 implements MigrationInterface {
    name = '$npmConfigName1701594667616'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "notification_preference" RENAME COLUMN "inAppNotificationEnabled" TO "notificationType"`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "notification_preference" ADD "inAppEnabled" boolean NOT NULL DEFAULT true`);
        await queryRunner.query(`ALTER TABLE "notification_preference" ADD "notificationType" boolean NOT NULL DEFAULT true`);
        await queryRunner.query(`ALTER TABLE "notification_preference" RENAME COLUMN "notificationType" TO "inAppNotificationEnabled"`);
    }
