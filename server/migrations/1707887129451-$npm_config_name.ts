...
export class $npmConfigName1707887129451 implements MigrationInterface {
    name = '$npmConfigName1707887129451'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."payment_paymentmethod_enum" AS ENUM('CREDIT_CARD', 'PAYPAL', 'BANK_TRANSFER', 'MPESA')`);
        await queryRunner.query(`CREATE TABLE "payment" ("id" SERIAL NOT NULL, "amount" integer NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "paymentMethod" "public"."payment_paymentmethod_enum" NOT NULL DEFAULT 'MPESA', "bookingId" integer, CONSTRAINT "PK_fcaec7df5adf9cac408c686b2ab" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."user_permissions_enum" AS ENUM('canAccessAdminDashboard', 'isSuperAdmin', 'canAccessClientDashboard', 'DeletePost', 'canBookTour', 'canAccesClientsProfile')`);
