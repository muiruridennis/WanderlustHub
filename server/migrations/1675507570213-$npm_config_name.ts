...
export class $npmConfigName1675507570213 implements MigrationInterface {
    name = '$npmConfigName1675507570213'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "payment" ("id" SERIAL NOT NULL, "paymentAmount" integer NOT NULL, "referenceNumber" character varying NOT NULL, "approved" boolean NOT NULL DEFAULT false, "paymentDate" TIMESTAMP NOT NULL DEFAULT now(), "clientId" integer, CONSTRAINT "PK_fcaec7df5adf9cac408c686b2ab" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "more_info" ("id" SERIAL NOT NULL, "bookedAtDate" TIMESTAMP NOT NULL DEFAULT now(), "updatedDate" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_1301f9a12af70884e60bbd91ded" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TYPE "public"."booking_status_enum" AS ENUM('Completed', 'Pending')`);
        await queryRunner.query(`CREATE TABLE "booking" ("id" SERIAL NOT NULL, "status" "public"."booking_status_enum" NOT NULL DEFAULT 'Completed', "bookingPlatform" character varying, "tourCost" integer NOT NULL, "tourDepositAmount" integer NOT NULL, "totalAmountPaid" integer NOT NULL, "discountAmount" integer NOT NULL, "sharingType" character varying NOT NULL, "moreInfoId" integer, "clientId" integer, CONSTRAINT "REL_f97d7dc846b815c415a02f45fe" UNIQUE ("moreInfoId"), CONSTRAINT "PK_49171efc69702ed84c812f33540" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "booking" ADD CONSTRAINT "FK_f97d7dc846b815c415a02f45fe6" FOREIGN KEY ("moreInfoId") REFERENCES "more_info"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "booking" ADD CONSTRAINT "FK_8e9ee03e1b661be752d2c3b5808" FOREIGN KEY ("clientId") REFERENCES "client"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "booking" DROP CONSTRAINT "FK_8e9ee03e1b661be752d2c3b5808"`);
        await queryRunner.query(`ALTER TABLE "booking" DROP CONSTRAINT "FK_f97d7dc846b815c415a02f45fe6"`);
        ...
        await queryRunner.query(`DROP TABLE "more_info"`);
