...
export class $npmConfigName1701587532317 implements MigrationInterface {
    name = '$npmConfigName1701587532317'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "notification_preference" ("id" SERIAL NOT NULL, "emailEnabled" boolean NOT NULL DEFAULT true, "smsEnabled" boolean NOT NULL DEFAULT true, "inAppNotificationEnabled" boolean NOT NULL DEFAULT true, "userId" integer, CONSTRAINT "REL_c8721bd56ae600308745ad4974" UNIQUE ("userId"), CONSTRAINT "PK_ba8d816b10f3dcfcd2e71ce5776" PRIMARY KEY ("id"))`);
