...
//create Tours
export const ADD_CLIENT_TO_TOUR = "ADD_CLIENT_TO_TOUR";
...
export const SEARCH_DIRECTOR = "SEARCH_DIRECTOR";
...
export const GET_CUSTOM_EVENT_BY_ID = "GET_CUSTOM_EVENT_BY_ID";
export const GET_ALL_CUSTOM_EVENTS = "GET_ALL_CUSTOM_EVENTS";
export const UPDATE_CUSTOM_EVENT= "UPDATE_CUSTOM_EVENT";
export const DELETE_CUSTOM_EVENT = "DELETE_CUSTOM_EVENT";
