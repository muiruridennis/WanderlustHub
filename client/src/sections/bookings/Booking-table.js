                  ...
                  {filteredBookings?.length ? (
                    filteredBookings.map((booking) => (
                      ...
                      <TableRow key={booking.id} sx={{ '&:last-child td, &:last-child th': { border: 0 } }}>
                        ...
                        <TableCell align="left">{booking.payment.amountPaid}</TableCell>
                        <TableCell align="left">{booking.payment && booking.payment.payingPhoneNumber}</TableCell>
                        ...
                        <TableCell align="left">{moment(booking.bookedAtDate).format('YYYY-MM-DD')}</TableCell>
